...
function createTicketRow(ticket) {
  ...
  editBtn.href = `/employee/employee-dashboard/ticket/${ticket._id}`;
...
select.addEventListener("change", () => {
  ...
  fetch(`employee-dashboard/tickets/${selectedOption}`, {
    method: "GET",
    headers: {
...
searchQuery.addEventListener("keyup", (e) => {
  ...
  if (search.length === 0) {
    fetch("/employee/employee-dashboard/all-tickets", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    fetch(`employee-dashboard/tickets-search/${search}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
